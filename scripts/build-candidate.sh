...
readonly CADDY_ARCHIVE_TAG='caddy:dsh-offline-2.11.4-arm64-1172d4213087'
...
"$REPO_ROOT/scripts/save-pinned-image.sh" "$CADDY_REF" linux/arm64 \
  "$CADDY_ARCHIVE_TAG" "$ARTIFACT_DIR/caddy-2.11.4-arm64.tar"
